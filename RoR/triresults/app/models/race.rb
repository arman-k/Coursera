class Race
    ...
    DEFAULT_EVENTS = {"swim" =>{:order=>0, :name=>"swim", :distance=>1.0, :units=>"miles"}, "t1"=>{:order=>1, :name=>"t1"}, "bike"=>{:order=>2, :name=>"bike", :distance=>25.0, :units=>"miles"}, "t2"=>{:order=>3, :name=>"t2"}, "run"=>{:order=>4, :name=>"run", :distance=>10.0, :units=>"kilometers"}}
    ...
    def self.upcoming_available_to racer
        ...
        Race.in(_id: all_upcoming_race_ids - upcoming_race_ids)
    end
end
